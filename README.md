> [!WARNING]
> ## WaterPlayer больше не поддерживается!
> В связи с тем, что я не заинтересован в проекте, прекращу его поддержку и выпущу в открытое плаванье.
> 
> Его API и Веб-сайт проработают до 20 мая, дальше они будут отключены.
> 
> Прошу прощения, но это вынужденная мера.
> С уважение, Кел Кофеин!
